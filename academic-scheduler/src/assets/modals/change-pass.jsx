...
const ChangePassModal = ({ isOpen, user, onChanged, onLogout }) => {
  ...
  useEffect(() => {
    if (!isOpen) return;
    // schedule reset to avoid calling setState synchronously in effect body
    const id = setTimeout(() => {
      setCurrentPass("");
      setNewPass("");
      setConfirmPass("");
        ...
        >
          ...
          >
            ...
            <div style={{ display: "grid", gap: "0.25rem" }}>
              <div style={{ color: ruleState.upper ? "#47d147" : "#ff8f8f" }}>
                • At least 1 capital letter
              </div>
              <div style={{ color: ruleState.lower ? "#47d147" : "#ff8f8f" }}>
                • At least 1 small letter
              </div>
              <div style={{ color: ruleState.number ? "#47d147" : "#ff8f8f" }}>
                • At least 1 number
              </div>
              <div style={{ color: ruleState.special ? "#47d147" : "#ff8f8f" }}>
                • At least 1 special character
              </div>
              <div style={{ color: ruleState.length ? "#47d147" : "#ff8f8f" }}>
                • 8 to 12 characters
              </div>
            </div>
          </div>
